    ...
    public function validateCardData($object)
    {
        ...
        foreach ($expectedFields as $field) {
            if (!isset($object->$field)) {
                throw new \PhalconRest\Util\ValidationException("Bad Credit Card Supplied: $field is required", [
        ...
        if ($result['valid'] == false) {
            throw new \PhalconRest\Util\ValidationException("Bad Credit Card Supplied", [
        ...
        if ($result == false) {
            throw new \PhalconRest\Util\ValidationException("Bad Expiration Date Supplied", [
